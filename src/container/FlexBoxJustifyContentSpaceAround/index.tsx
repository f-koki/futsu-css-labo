...
const FlexBoxJustifyContentSpaceAround: React.FC = () => {
  return (
    <StyledFlexBox className="FlexBoxJustifyContentSpaceAround">
...
export default FlexBoxJustifyContentSpaceAround;
